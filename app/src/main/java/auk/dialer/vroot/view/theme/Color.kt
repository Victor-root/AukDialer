...
const val AUK_BRAND_SEED: Int = 0xFF0061A4.toInt()

val AukLightColorScheme: ColorScheme = lightColorScheme(
...
val AukDarkColorScheme: ColorScheme = darkColorScheme(
...
fun aukColorSchemeFromSeed(seedArgb: Int, darkTheme: Boolean): ColorScheme {
...
fun aukCallColors(colorScheme: ColorScheme, darkTheme: Boolean): CallColors {
...
val LocalCallColors: ProvidableCompositionLocal<CallColors> = staticCompositionLocalOf {
    aukCallColors(AukLightColorScheme, darkTheme = false)
}
